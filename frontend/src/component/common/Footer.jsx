            ...
            <div className="container mx-auto px-4">
                <div className="flex flex-col md:flex-row justify-between items-center">
                    ...
                    <div className="mb-4 md:mb-0">
                        <span className="text-xl font-bold text-amber-400">Phegon Hotel</span>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
                        <div>
                            <h3 className="text-amber-400 font-medium mb-2">Explore</h3>
                        ...
                        <div>
                            <h3 className="text-amber-400 font-medium mb-2">Company</h3>
                            <ul className="space-y-2">
                        ...
                        <div>
                            <h3 className="text-amber-400 font-medium mb-2">Legal</h3>
                            <ul className="space-y-2">
                                <li><a href="/privacy" className="text-gray-300 hover:text-white transition-colors">Privacy Policy</a></li>
                                <li><a href="/terms" className="text-gray-300 hover:text-white transition-colors">Terms of Service</a></li>
                                <li><a href="/cancellation" className="text-gray-300 hover:text-white transition-colors">Cancellation Policy</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex flex-col md:flex-row justify-between items-center">
                    ...
                    <div className="text-center md:text-right">
                        ...
                        <p className="text-gray-400">Email: info@phegonhotel.com</p>
                    </div>
                </div>
            </div>
        </footer>
